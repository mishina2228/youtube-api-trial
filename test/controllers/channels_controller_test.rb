...
class ChannelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should get edit_tags' do
    sign_in admin

    get edit_tags_channel_path(id: @channel), xhr: true
    assert_response :success
  end
  ...
  test 'should redirect to channel page when get edit_tags without using ajax' do
    ...
    get edit_tags_channel_path(id: @channel)
    assert_response :redirect
    assert_redirected_to channel_url(id: @channel)
  end

  test 'should not get edit_tags if logged in as an user' do
    sign_in user
  ...
  test 'should not get edit_tags unless logged in' do
    assert_raise CanCan::AccessDenied do
      get edit_tags_channel_path(id: @channel), xhr: true
    end
    assert_raise CanCan::AccessDenied do
  ...
  test 'should not update tags with passing tag_list as an array' do
    ...
    put update_tags_channel_path(id: @channel),
        params: {
          channel: {
